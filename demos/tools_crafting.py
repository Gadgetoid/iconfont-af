# Tools Crafting icons - 162 glyphs from tools_crafting.af
#
...
# for the character-to-name mapping. Place tools_crafting.af alongside this script on the
# badge, or adjust the load path below.
#
# These are scalable vector fonts, so raise SIZE for larger, smoother icons.

FONT = "tools_crafting.af"
COUNT = 162
