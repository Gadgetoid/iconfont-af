# Warfare icons - 38 glyphs from warfare.af
#
...
# for the character-to-name mapping. Place warfare.af alongside this script on the
...
COLS = 6        # icons per row
PITCH = 50       # cell size in pixels
SIZE = 27        # glyph em-height in pixels
MARGIN = 5       # left/top inset
